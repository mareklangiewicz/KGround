...
defaultBuildTemplateForMppLib(details) {
...
application {
    mainClass.set("pl.mareklangiewicz.kground.playground.KGroundPlaygroundKt")
}

tasks.processJupyterApiResources {
    libraryProducers = listOf("pl.mareklangiewicz.kground.KGroundIntegration")
}
