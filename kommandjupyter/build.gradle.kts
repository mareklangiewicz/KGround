...
// Note: I tried to use Jvm only templates for kommandjupyter module, but it's way worse approach.
// I'd have to use java plugin for source jar generation (and had problems with that) (BTW needed for sonatype),
