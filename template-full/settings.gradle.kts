...
plugins {
  id("pl.mareklangiewicz.deps.settings") version "0.3.45" // https://plugins.gradle.org/search?term=mareklangiewicz
  id("com.gradle.develocity") version "3.18" // https://docs.gradle.com/develocity/gradle-plugin/
}
