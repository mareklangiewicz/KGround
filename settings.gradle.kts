...
plugins {
  id("pl.mareklangiewicz.deps.settings") version "0.4.12" // https://plugins.gradle.org/search?term=mareklangiewicz
  id("com.gradle.develocity") version "4.4.0" // https://docs.gradle.com/develocity/gradle-plugin/
}
