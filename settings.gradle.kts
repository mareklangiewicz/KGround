...
plugins {
  id("pl.mareklangiewicz.deps.settings") version "0.3.78" // https://plugins.gradle.org/search?term=mareklangiewicz
  id("com.gradle.develocity") version "4.0" // https://docs.gradle.com/develocity/gradle-plugin/
}
