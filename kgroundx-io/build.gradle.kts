...
defaultBuildTemplateForBasicMppLib {
    ...
    findProject(":kommandline")?.let { api(it) } ?: api(Langiewicz.kommandline.withVer("0.0.47"))
    findProject(":kommandsamples")?.let { api(it) } ?: api(Langiewicz.kommandsamples.withVer("0.0.47"))
