...
public data class DownloadArtifact_Untyped private constructor(
...
) : RegularAction<DownloadArtifact_Untyped.Outputs>("actions", "download-artifact", _customVersion ?: "v8") {
    public constructor(
    ...
    ) : this(name_Untyped = name_Untyped, artifactIds_Untyped = artifactIds_Untyped, path_Untyped = path_Untyped, pattern_Untyped = pattern_Untyped, mergeMultiple_Untyped = mergeMultiple_Untyped, githubToken_Untyped = githubToken_Untyped, repository_Untyped = repository_Untyped, runId_Untyped = runId_Untyped, skipDecompress_Untyped = skipDecompress_Untyped, digestMismatch_Untyped = digestMismatch_Untyped, _customInputs = _customInputs, _customVersion = _customVersion)
