...
public data class Checkout_Untyped private constructor(
...
) : RegularAction<Checkout_Untyped.Outputs>("actions", "checkout", _customVersion ?: "v7") {
    public constructor(
    ...
    ) : this(repository_Untyped = repository_Untyped, ref_Untyped = ref_Untyped, token_Untyped = token_Untyped, sshKey_Untyped = sshKey_Untyped, sshKnownHosts_Untyped = sshKnownHosts_Untyped, sshStrict_Untyped = sshStrict_Untyped, sshUser_Untyped = sshUser_Untyped, persistCredentials_Untyped = persistCredentials_Untyped, path_Untyped = path_Untyped, clean_Untyped = clean_Untyped, filter_Untyped = filter_Untyped, sparseCheckout_Untyped = sparseCheckout_Untyped, sparseCheckoutConeMode_Untyped = sparseCheckoutConeMode_Untyped, fetchDepth_Untyped = fetchDepth_Untyped, fetchTags_Untyped = fetchTags_Untyped, showProgress_Untyped = showProgress_Untyped, lfs_Untyped = lfs_Untyped, submodules_Untyped = submodules_Untyped, setSafeDirectory_Untyped = setSafeDirectory_Untyped, githubServerUrl_Untyped = githubServerUrl_Untyped, allowUnsafePrCheckout_Untyped = allowUnsafePrCheckout_Untyped, _customInputs = _customInputs, _customVersion = _customVersion)
