...
public data class UploadArtifact_Untyped private constructor(
...
) : RegularAction<UploadArtifact_Untyped.Outputs>("actions", "upload-artifact", _customVersion ?: "v7") {
    public constructor(
    ...
    ) : this(name_Untyped = name_Untyped, path_Untyped = path_Untyped, ifNoFilesFound_Untyped = ifNoFilesFound_Untyped, retentionDays_Untyped = retentionDays_Untyped, compressionLevel_Untyped = compressionLevel_Untyped, overwrite_Untyped = overwrite_Untyped, includeHiddenFiles_Untyped = includeHiddenFiles_Untyped, archive_Untyped = archive_Untyped, _customInputs = _customInputs, _customVersion = _customVersion)
